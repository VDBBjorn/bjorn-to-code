...
const config: SiteConfig = {
  ...
  site: 'https://vdbbjorn.github.io/bjorn-to-build/',
  ...
  socialCardAvatarImage: 'https://avatars.githubusercontent.com/u/4362040?v=4',
  ...
  socialLinks: {
    github: 'https://github.com/VDBBjorn',
    email: 'bjorn@codest.be',
    linkedin: 'https://www.linkedin.com/in/vdbbjorn/',
    twitter: 'https://x.com/vdbbjorn',
